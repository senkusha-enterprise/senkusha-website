...
const ServicesCarousel = ({ services = [] }) => {
  ...
  const positionStyles = {
    ...
    center:
      "z-20 scale-100 opacity-100 mx-2 md:mx-4 lg:mx-6 w-full max-w-xl shadow-2xl bg-white/90 backdrop-blur-lg",
    right:
      "z-10 scale-80 md:scale-90 opacity-50 md:opacity-60 -ml-6 md:-ml-8 lg:-ml-12 w-[70%] md:w-[75%] max-w-md",
  };
              ...
              className={`transition-all duration-700 ease-in-out rounded-xl sm:rounded-2xl md:rounded-3xl h-[280px] sm:h-[340px] md:h-[400px] lg:h-[450px] flex items-stretch \
                ${
                  card.position === "center"
                    ? "w-[85%] sm:w-[80%] md:w-[70%] lg:w-[50%] max-w-2xl"
                    : "w-[65%] sm:w-[70%] md:w-[60%] lg:w-[40%] max-w-lg"
                } \
